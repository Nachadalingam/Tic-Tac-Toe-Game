...
import TicTacToe.stretegies.ColumnWinningStrategy;
import TicTacToe.stretegies.RowWinningStrategy;
import TicTacToe.stretegies.WinningStrategy;
...
public class Client {
    public static void main(String[] args) {
        ...
        try {
            ...
            players.add(new Player(1 , "Mohit", PlayerType.
                    HUMAN , new Symbol('X' , "Green")));
            players.add(new Bot(2 , "Botty",
                    new Symbol('O' , "Green"), BotDifficultyLevel.EASY));
