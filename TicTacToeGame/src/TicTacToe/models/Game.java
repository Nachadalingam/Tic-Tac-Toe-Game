...
public class Game {
    ...
    public static class Builder{
        ...
        void validateSymbolCount(){
            ...
            HashSet<Symbol>symbolHashSet=new HashSet<>();
            for(int i=0;i<players.size();i++)
            {
                symbolHashSet.add(players.get(i).getPlayerSymbol());
            }
            if(symbolHashSet.size()!=dimension-1)
            {
                throw new RuntimeException("Invalid Player Please Enter the correct symbol:");
            }
        }
        void validate(){
            // Bot count
